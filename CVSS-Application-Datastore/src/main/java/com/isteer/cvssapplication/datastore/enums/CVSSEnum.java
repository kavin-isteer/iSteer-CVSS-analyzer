...
public enum CVSSEnum {
	...
	COMPUTER_APP_UPDATE(2006, "computer.application.update"), COMPUTER_DELETE(2003, "computer.delete"),
	COMPUTER_NOT_FOUND(2004, "computer.notfound"), COMPUTER_UUID_EMPTY(2007, "computer.uuid.empty"),
	IP_ADDRESS_INVALID(2001, "ip.invalid"), COMPUTER_WITH_SAME_IP_EXISTS(2005, "computer.duplicate.ip"),
	...
	APPLICATION_ADD(2100, "application.add"), APPLICATION_UPDATE(2102, "application.update"),
	APPLICATION_DELETE(2103, "application.delete"), APPLICATION_NOT_FOUND(2104, "application.notfound"),
	...
	VULNERABILITY_ADD(2200, "vulnerability.add"), VULNERABILITY_UPDATE(2202, "vulnerability.update"),
	VULNERABILITY_DELETE(2203, "vulnerability.delete"), VULNERABILITY_NOT_FOUND(2204, "vulnerability.notfound"),
	...
	VULNERABILITY_CVSS_SCORE_INVALID(5007, "vulnerability.cvss.score.invalid"), INVALID_CVE_ID(5001, "invalid.cve.id"),
