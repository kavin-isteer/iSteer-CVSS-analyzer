...
public class CvssController {
    ...
    /**
     * Starts a vulnerability analysis process and streams updates to the client using Server-Sent Events (SSE).
     * The analysis is performed in a separate thread to avoid blocking the request thread.
     *
     * @return SseEmitter to stream analysis progress and final message.
     */
    
    //FIXME: Check if it will raise any issues by using new thread and handle multi threading issues.
     ...
     *
     * @param cpe The full CPE name to search for (e.g., "cpe:2.3:a:apache:log4j:2.14.1").
